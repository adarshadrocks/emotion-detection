...
if __name__ == '__main__':
    ...
    # load smile data
    PATH = "/home/adarsh/Desktop/emotion-detection-master/data/smile/"
    for idx, filename in enumerate(smilefiles):
        phi[idx] = vectorize(PATH + filename)
        labels.append(1)

    # load neutral data    
    PATH = "/home/adarsh/Desktop/emotion-detection-master/data/neutral/"
    offset = idx + 1
    ...
    while rval:
       ...
       #  For 64 bit systems use, use key=cv2.waitKey(40) & 0xFF
        ...
        if key == 32: # press space to save images
            ...
            #cv2.SaveImage("webcam.jpg", cv.fromarray(frame))
